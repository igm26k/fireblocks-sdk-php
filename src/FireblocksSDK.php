...
namespace FireblocksSdkPhp;

use FireblocksSdkPhp\Exceptions\FireblocksApiException;
use FireblocksSdkPhp\Http\FireblocksApiClient;
use FireblocksSdkPhp\Types\DestinationTransferPeerPath;
use FireblocksSdkPhp\Types\Enums\FeeLevelEnums;
use FireblocksSdkPhp\Types\Enums\PeerEnums;
use FireblocksSdkPhp\Types\Enums\SigningAlgorithmEnums;
use FireblocksSdkPhp\Types\Enums\TransactionEnums;
use FireblocksSdkPhp\Types\Enums\TransactionStatusEnums;
use FireblocksSdkPhp\Types\PagedVaultAccountsRequestFilters;
use FireblocksSdkPhp\Types\RawMessage;
use FireblocksSdkPhp\Types\TransactionDestination;
use FireblocksSdkPhp\Types\TransferPeerPath;
use FireblocksSdkPhp\Types\TransferTicketTerm;

class FireblocksSDK
{
    /**
     * Creates a new Fireblocks API Client.
     * @param string|array|OpenSSLAsymmetricKey|OpenSSLCertificate $private_key A string representation of your private key (in PEM format) openssl_pkey_get_private("file:///path.to/jwtRS256.key");
     * @param string $api_key Your api key. This is a uuid you received from Fireblocks
     * @param string $api_base_url The fireblocks server URL. Leave empty to use the public functionault server default: https://api.fireblocks.io
     * @param int|null $timeout Timeout for http requests in seconds default 10sec
     */
    public function __construct($private_key, string $api_key, string $api_base_url = 'https://api.fireblocks.io', int $timeout = null)
    {
